...
public class CreateEmailTextSequence extends Configured implements Tool{
	...
	public static class Map extends MapReduceBase implements Mapper<Text, BytesWritable, Text, Text> {
		public void map(Text key, BytesWritable value, OutputCollector<Text, Text> output, Reporter reporter) throws IOException {
			...
			try {
					EmailParser eparse = new EmailParser(input);
					output.collect(key, new Text(eparse.getParsedEmail(":", ",", "\n")));
	...
	public int run(String[] args) throws Exception {
		...
		conf.setJobName("CreateEmailTextSequence");
	...
	public static void main(String[] args) throws Exception {
		int exitCode = ToolRunner.run(new CreateEmailTextSequence(), args);
