...
public class CreatePresentationTextSequence extends Configured implements Tool{
	public static class Map extends MapReduceBase implements Mapper<Text, BytesWritable, Text, Text> {
		public void map(Text key, BytesWritable value, OutputCollector<Text, Text> output, Reporter reporter) throws IOException {
			...
			try {
				PresentationParser pparse = new PresentationParser(input);
				output.collect(key, new Text(pparse.getParsedPresentation()));
	...
	public int run(String[] args) throws Exception {
		...
		conf.setJobName("CreatePresentationTextSequence");
	...
	public static void main(String[] args) throws Exception {
		int exitCode = ToolRunner.run(new CreatePresentationTextSequence(), args);
