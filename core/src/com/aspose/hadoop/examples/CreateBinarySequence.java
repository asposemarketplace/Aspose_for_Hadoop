...
public class CreateBinarySequence extends Configured
implements Tool{
  ...
  public int run(String[] args) throws IOException {
	  JobConf jobConf = new JobConf(CreateBinarySequence.class);
		jobConf.setJobName("CreateBinarySequence");
  ...
  public static void main(String[] args) throws Exception {
	  int exitCode = ToolRunner.run(new CreateBinarySequence(), args);
