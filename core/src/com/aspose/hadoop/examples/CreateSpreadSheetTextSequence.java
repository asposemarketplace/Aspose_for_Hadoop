...
public class CreateSpreadSheetTextSequence extends Configured implements Tool{
	public static class Map extends MapReduceBase implements Mapper<Text, BytesWritable, Text, Text> {
		public void map(Text key, BytesWritable value, OutputCollector<Text, Text> output, Reporter reporter) throws IOException {
			...
			try {
					SpreadSheetParser sparse = new SpreadSheetParser(input);
					output.collect(key, new Text(sparse.getParsedSpreadSheet()));
	...
	public int run(String[] args) throws Exception {
		...
		conf.setJobName("CreateSpreadSheetTextSequence");
	...
	public static void main(String[] args) throws Exception {
		int exitCode = ToolRunner.run(new CreateSpreadSheetTextSequence(), args);
